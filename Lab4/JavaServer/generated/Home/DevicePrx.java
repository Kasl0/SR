...
public interface DevicePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        setName(name, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setName(String name, java.util.Map<String, String> context)
    {
        _iceI_setNameAsync(name, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> setNameAsync(String name)
    {
        return _iceI_setNameAsync(name, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setNameAsync(String name, java.util.Map<String, String> context)
    {
        return _iceI_setNameAsync(name, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setNameAsync(String iceP_name, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setName", null, sync, null);
