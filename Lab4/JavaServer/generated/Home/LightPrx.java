...
public interface LightPrx extends ActuatorDevicePrx
{
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getBrightness", null, sync, _iceE_getBrightness);
    ...
    default void setBrightness(float brightness, java.util.Map<String, String> context)
        throws DeviceDeactivatedException,
               InvalidArgumentException
    {
        try
    ...
    default java.util.concurrent.CompletableFuture<Void> setBrightnessAsync(float brightness)
    {
        return _iceI_setBrightnessAsync(brightness, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setBrightnessAsync(float brightness, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setBrightnessAsync(float iceP_brightness, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, null, ostr -> {
                     ostr.writeFloat(iceP_brightness);
                 }, null);
        return f;
    }
